...
insert into organization (id, description, create_date, name, state, organization_maker_id) values (1, "asfdsadfsadfasfasdfsa asf  sdfas sdf ", CURRENT_TIMESTAMP(), "first organization" ,"ordinary", 1);
...
INSERT INTO issue (id, contents, state, subject, write_date, writer_id, organization_id, milestone_id) VALUES (3, 'third issue contents', 'CLOSE', 'third issue', CURRENT_TIMESTAMP(), 1, 1, 5);
INSERT INTO issue (id, contents, state, subject, write_date, writer_id, organization_id, milestone_id) VALUES (4, 'fourth issue contents', 'OPEN', 'fourth issue', CURRENT_TIMESTAMP(), 3, 1, 3);
